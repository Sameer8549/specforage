...
export default function AdminPage() {
  ...
  const metrics = useMemo(() => {
    ...
    return { lookups: lookups.length, hits, adjudicated };
  }, [records]);
  ...
  return <main className="admin-page">
    ...
    <section className="admin-metrics">
      ...
      <div><span className="text-mono-label">Skipped Adjudicate</span><strong>{records.length - metrics.adjudicated}</strong><small>resolved without a conflict LLM call</small></div>
    </section>
